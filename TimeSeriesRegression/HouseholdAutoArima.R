...
powerData <- read.csv("/Users/srinath/playground/data-science/keras-theano/TimeSeriesRegression/household_power_consumption200k.txt", sep = ";")


x_all = powerData$Global_active_power
